#!/usr/bin/env python3
"""
Evaluation Script for BeyondAIME Benchmark (SFT)
...
def main():
    parser = argparse.ArgumentParser(description="Evaluation on BeyondAIME for SFT with statistical significance testing")
    ...
    logger.info("=" * 60)
    logger.info("BeyondAIME Evaluation (SFT)")
    logger.info("=" * 60)
